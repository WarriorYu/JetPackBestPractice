...
import com.yu.libcommon.utils.PixUtils;
import com.yu.libcommon.view.ViewHelper;
...
public class PPImageView extends AppCompatImageView {
    ...
    private void setImageUrl(PPImageView view, String imageUrl, boolean isCircle, int radius) {
