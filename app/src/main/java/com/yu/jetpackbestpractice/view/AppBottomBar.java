package com.yu.jetpackbestpractice.view;
...
import com.yu.jetpackbestpractice.utils.AppConfig;
 ...
 * @author :   yuxibing
 * @date :   2020/12/10
 * Describe : 自定义BottomNavigationView
 */
public class AppBottomBar extends BottomNavigationView {
    ...
    public AppBottomBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        state[1] = new int[]{};
        int[] colors = {Color.parseColor(config.activeColor), Color.parseColor(config.inActiveColor)};
