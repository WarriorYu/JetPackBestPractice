package com.yu.libcompiler;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.auto.service.AutoService;
import com.yu.libnavannotation.ActivityDestination;
...
@SupportedAnnotationTypes({"com.yu.libnavannotation.FragmentDestination", "com.yu.libnavannotation.ActivityDestination"})
public class NavProcessor extends AbstractProcessor {
    ...
    private void handleDestination(Set<? extends Element> elements, Class<? extends Annotation> annotationClaz, HashMap<String, JSONObject> destMap) {
        for (Element element : elements) {
            ...
            //全类名com.yu.JetPackBestPractice.home
