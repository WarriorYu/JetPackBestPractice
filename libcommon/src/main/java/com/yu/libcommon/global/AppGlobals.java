package com.yu.libcommon.global;
...
public class AppGlobals {
    ...
    public static Application getApplication() {
        if (sApplication == null) {
            ...
            try {
                sApplication = (Application) Class.forName("android.app.ActivityThread").getDeclaredMethod("currentApplication").invoke(null, (Object) null);
